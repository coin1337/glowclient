...
public final class BlockUtils {
    ...
    public static boolean placeBlockLegit(BlockPos pos) {
        ...
        for (EnumFacing side : EnumFacing.values()) {
            ...
            if (!(eyesPos.squareDistanceTo(vec3d) <= 18.0625) || !(distanceSqPosVec <= eyesPos.squareDistanceTo(posVec.add(dirVec))) || WMinecraft.getWorld().rayTraceBlocks(eyesPos, hitVec, false, true, false) != null) continue;
