...
extends ServiceMod {
    ...
    private final String textureurl = "https://raw.githubusercontent.com/GlowClient/GlowClient.github.io/master/assets/ColorCodes.png";
    private final String textureurl2 = "https://raw.githubusercontent.com/GlowClient/GlowClient.github.io/master/assets/wrench.png";
    ...
    public void onLoad() {
        Globals.MC.addScheduledTask(() -> {
            try {
                BufferedImage image = this.getImageFromUrl("https://raw.githubusercontent.com/GlowClient/GlowClient.github.io/master/assets/ColorCodes.png");
                BufferedImage image2 = this.getImageFromUrl("https://raw.githubusercontent.com/GlowClient/GlowClient.github.io/master/assets/wrench.png");
                if (image == null) {
