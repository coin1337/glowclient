    ...
    private void placeBlockScaffold(BlockPos pos) {
        try {
            ...
            for (EnumFacing side : EnumFacing.values()) {
                ...
                Vec3d vec3d3 = new Vec3d((Vec3i)neighbor);
                if (!(eyesPos.squareDistanceTo(vec3d2.add(0.5, 0.5, 0.5)) < eyesPos.squareDistanceTo(vec3d3.add(0.5, 0.5, 0.5))) || !WBlock.canBeClicked(neighbor)) continue;
